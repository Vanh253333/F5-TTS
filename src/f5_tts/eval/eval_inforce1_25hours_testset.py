# Evaluate with inforce1_25hours testset
...
def get_args():
    ...
    parser.add_argument("-l", "--lang", type=str, default="vi", choices=["vi", "zh", "en"])
...
def main():
    ...
    metalst = rel_path + f"data/infore1_25hours/metadata.lst"  # seed-tts testset
