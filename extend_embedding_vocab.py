...
if __name__ == "__main__":
    ...
    TOKEN_NEW_PATH = "data/vivoice_char/vocab.txt"
    ...
    ckpt_path = "ckpts/vivoice/model_1250000.safetensors"
    new_ckpt_path = "ckpts/vivoice/pretrained_model_1250000.safetensors"
